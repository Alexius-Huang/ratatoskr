  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 bg-nord-1 border border-nord-3 rounded-lg shadow-xl w-full max-w-2xl mx-4 flex flex-col max-h-[90vh]">
        <header className="flex items-center justify-between px-6 py-4 border-b border-nord-3 shrink-0">
        ...
        {footer && (
          <footer className="px-6 py-4 border-t border-nord-3 shrink-0 flex justify-end gap-2">
            {footer}
          </footer>
        )}
      </div>
